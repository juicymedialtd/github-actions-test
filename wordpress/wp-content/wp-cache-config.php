...
$wp_cache_debug_username = 'a5c128a2977ec7393c12a0576514098c';
$wp_cache_home_path = '/';
$wp_cache_slash_check = 1;
$cache_page_secret = '796cc48f6cd796d8106601957c0886c5';
$cache_time_interval = '1800';
if ( ! defined('WPCACHEHOME') )
	define( 'WPCACHEHOME', WP_CONTENT_DIR . "/plugins/wp-super-cache/" );

$cache_compression = 0; // Super cache compression
$cache_enabled =  getenv('WP_ENVIRONMENT_TYPE') != 'development';
$super_cache_enabled =  getenv('WP_ENVIRONMENT_TYPE') != 'development';
$cache_max_time = 7200;
//$use_flock = true; // Set it true or false if you know what to use
$cache_path = defined('WP_CACHE_PATH') ? WP_CACHE_PATH : WP_CONTENT_DIR . '/cache/';
...
$wp_cache_debug_ip = '';
$wp_cache_debug_log = 'beb751bce896b04e429fa15f18928a05.php';
